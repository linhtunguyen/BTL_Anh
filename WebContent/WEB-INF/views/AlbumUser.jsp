...
<div class="wrapper ">
        ...
        <div class="main-panel">
			...
			<div class="container-fluid">
				<form class="navbar-form navbar-right" action="/Home/SearchAlbum"
					method="post" style="position: relative; top: 50px">
					<div class="form-group bmd-form-group">
						<input type="text" class="form-control" name="search"
							placeholder="Tìm kiếm ..."
							style="position: relative; border-top: 1px solid gray; width: 301px"><br>
					</div>
					<button type="submit" class="btn btn-default"
						style="position: relative; top: -75px; left: 300px; height: 35px">
						<img src="../Images/icon-tim-kiem.png" width="18"
							height="16">
				...
				<div class="row" style="width: 100%">
					<c:forEach items="${ Albums}" var="item">
						...
						<div class="col-md-3" style="margin: 10px 0;">
							<img src="../Images/${item.albumId}/${Image.imageUrl}"
							...
							<a class="btn center-block" style="margin: auto"
								href="/Home/DeleteAlbum/?AlbumID=@it.AlbumID">Xóa</a> <a
								class="btn  center-block" style="margin: auto"
								data-toggle="modal" data-book-id=@it.AlbumID id="BtnChiaSe"
